        ...
        <div class="container mt-5">
            <div class="row ">
                ...
                <div class="col-6 index-card d-flex flex-column align-items-center justify-content-center p-3">
                    ...
                    <h1>Pondok Bahrul Ulum</h1>
                    <h2>Quiz App</h2>
                    <h4>Desa Marga Kaya, Kecamatan Jatiagung</h4>
                    <h4>Kabupaten Lampung Selatan</h4>
                    <a href="login.php" class="button-mulai mt-3">MULAI</a>
                    <div class="mt-5 mb-3">
                        <span><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-instagram mx-1" viewBox="0 0 16 16">
                            ...
                            </svg><a href="https://www.instagram.com/bahrululum_jatiagung?igsh=ZTI1ajFzYjZpbzM3" class="socialmedia me-5">Instagram</a></span>
                        <span><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-facebook mx-1" viewBox="0 0 16 16">
                            ...
                            </svg><a href="https://www.facebook.com/share/17ZDG9xyBR/" class="socialmedia">Facebook</a></span>
                    </div>
                </div>
                <div class="col-3"></div>
            </div>    
